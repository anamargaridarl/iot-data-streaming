...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            mqttClient?.subscribe("test/ssltopic", 1)
            runOnUiThread {
                Log.d("MQTT", "Subscribed to topic: test/ssltopic")
            }
    ...
    @Composable
    fun GreetingCall(name: String, modifier: Modifier = Modifier) {
        Button(onClick = {
            Log.d("MQTT", "Button clicked!")
            publishMessage("test/ssltopic", Greeting("Hello World!", "EN"))
